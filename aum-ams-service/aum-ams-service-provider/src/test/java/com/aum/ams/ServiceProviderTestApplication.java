...
public class ServiceProviderTestApplication {
    ...
    private static Logger logger = LoggerFactory.getLogger(ServiceProviderTestApplication.class);
...
//        EnvironmentUtils.setAdditionalConfigLocation("classpath:template/");// 用于外部文件测试
        ...
        ConfigurableApplicationContext context = SpringApplication.run(ServiceProviderTestApplication.class, args);
