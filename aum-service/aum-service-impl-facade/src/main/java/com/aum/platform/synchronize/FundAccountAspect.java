package com.aum.platform.synchronize;

import com.aum.platform.AmqpConfiguration;
import com.aum.platform.modules.fundaccount.FundAccountVo;
...
public class FundAccountAspect {
    ...
    @Pointcut("execution(* com.aum.platform.modules.fundaccount.FacadeFundAccountService.createAccount(..))&&args(fundAccountVo)")
